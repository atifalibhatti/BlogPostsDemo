...
using LetsPost.Search.Application;
using Microsoft.AspNetCore.Diagnostics;
using System.Diagnostics;
using Newtonsoft.Json;
using System.Text;
using LetsPost.Search.Api.Settings;
using LetsPost.Search.Api.Middleware;

namespace LetsPost.Search.Api;
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddAppServices(docDbSettings.DocConnectionString, docDbSettings.DocDatabaseName);
    }
